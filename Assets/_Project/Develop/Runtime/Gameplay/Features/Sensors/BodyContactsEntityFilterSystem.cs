...
{
    public class BodyContactsEntityFilterSystem : IInitializableSystem, IUpdatableSystem
    {
        // References
        ...
        public BodyContactsEntityFilterSystem(CollidersRegistryService collidersRegistryService)
            => _collidersRegistryService = collidersRegistryService;

        public void OnInit(Entity entity)
        {
            _colliders = entity.ContactCollidersBuffer;
